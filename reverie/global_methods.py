...
# 新增這行：Deepseek Chat Completion
from deepseek_adapter import chat_completion
...
# ====================（加一個示例 Deepseek 調用 function）====================
def generate_response_with_deepseek(prompt, system_message=None):
    """
    用 Deepseek ChatCompletion 生成回應
    """
    messages = []
    if system_message:
